...
// Настройка баз данных NeDB (укажи свои пути к файлам)
const matchesDb = Datastore.create({ filename: path.join(__dirname, '../db/matches.db'), autoload: true });
const betsDb = Datastore.create({ filename: path.join(__dirname, '../db/bets.db'), autoload: true });
...
module.exports = {
    ...
    getBookmakerConfig: () => BOOKMAKER_CONFIG
